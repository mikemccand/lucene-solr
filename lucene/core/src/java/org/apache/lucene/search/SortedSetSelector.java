...
public class SortedSetSelector {
  ...
  static class MinValue extends SortedDocValuesIterator {
    ...
    MinValue(SortedSetDocValuesIterator in) {
      this.in = in;
    }
  ...
  static class MaxValue extends SortedDocValuesIterator {
    ...
    MaxValue(SortedSetDocValuesIterator in) {
      this.in = in;
    }
  ...
  static class MiddleMinValue extends SortedDocValuesIterator {
    ...
    MiddleMinValue(SortedSetDocValuesIterator in) {
      this.in = in;
    }
  ...
  static class MiddleMaxValue extends SortedDocValuesIterator {
    ...
    MiddleMaxValue(SortedSetDocValuesIterator in) {
      this.in = in;
    }
