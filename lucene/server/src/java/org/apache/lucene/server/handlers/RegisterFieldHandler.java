...
public class RegisterFieldHandler extends Handler {
  ...
  private final static StructType FIELD_TYPE =
    new StructType(
        ...
        new Param("numericPrecisionStep", "If the value is numeric, what precision step to use during indexing.", new IntType(), LegacyNumericUtils.PRECISION_STEP_DEFAULT), // nocommit is 16 better?
  ...
  public static Version getVersion(String v) {
    ...
    } else if (v.equals("LUCENE_70")) {
      return Version.LUCENE_7_0_0;
    } else {
