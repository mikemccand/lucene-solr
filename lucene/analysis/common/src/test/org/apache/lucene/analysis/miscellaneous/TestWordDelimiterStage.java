...
public class TestWordDelimiterStage extends BaseStageTestCase {
  ...
  public void testOffsets() throws IOException {
    ...
    // the correct offsets.
    WordDelimiterStage wdf = new WordDelimiterStage(new CannedStage(), DEFAULT_WORD_DELIM_TABLE, flags, null);
    assertStageContents(wdf,
  ...
  private void doSplit(final String input, String... output) throws Exception {
    int flags = GENERATE_WORD_PARTS | GENERATE_NUMBER_PARTS | SPLIT_ON_CASE_CHANGE | SPLIT_ON_NUMERICS | STEM_ENGLISH_POSSESSIVE;
    WordDelimiterStage wdf = new WordDelimiterStage(new KeywordStage(new ReaderStage()),
                                                    WordDelimiterIterator.DEFAULT_WORD_DELIM_TABLE, flags, null);
    assertStageContents(wdf, input, new Object[] {output});
  }
  ...
  public void doSplitPossessive(int stemPossessive, final String input, final String... output) throws Exception {
    ...
    WordDelimiterStage wdf = new WordDelimiterStage(new KeywordStage(new ReaderStage()), flags, null);
    assertStageContents(wdf, input, new Object[] {output});
  }
  ...
  // make sure WDS can consume a graph:
  public void testGraphInput() throws Exception {
    int flags = GENERATE_WORD_PARTS | CATENATE_ALL | SPLIT_ON_CASE_CHANGE | PRESERVE_ORIGINAL;
    WordDelimiterStage wdf = new WordDelimiterStage(new CannedStage(), flags, null);
    assertAllPaths(wdf,
                   new Object[] {
                     new String[] {"FooBar", "Ba-foo", "beep"},
                     new int[] {0, 0, 7},
                     new int[] {6, 6, 11},
                     new int[] {0, 0, 1},
                     new int[] {1, 1, 2}},
  ...
  public void testLotsOfConcatenating() throws Exception {
    ...
    assertStageContents(wdf,
                        ...
                        new int[] {0, 0, 0, 2, 3, 3, 4},
                        new int[] {1, 3, 2, 3, 1, 4, 1});
  }
  ...
  public void testLotsOfConcatenating2() throws Exception {
    ...
    assertStageContents(wdf,
                        ...
                        new int[] {0, 0, 0, 0, 2, 3, 3, 4},
                        new int[] {1, 1, 3, 2, 3, 1, 4, 1});
  }

  // nocommit need testRandomData
  ...
  /** Does (hopefully) the same thing as WordDelimiterStage, according to the flags, but more slowly, returning all string paths combinations. */
  private Set<String> slowWDF(String text, int flags) {
    ...
    } else if (has(flags, PRESERVE_ORIGINAL) == false) {
      // only delimiters, marked as a deleted token
      paths.add("x:" + text);
    }
  ...
  private Stage getStage(int flags) {
    return new WordDelimiterStage(new KeywordStage(new ReaderStage()), flags, null);    
  }

  public void testBasicGraphSplits() throws Exception {
    assertAllPaths(getStage(0),
                   "PowerShotPlus",
                   "PowerShotPlus");
    assertAllPaths(getStage(GENERATE_WORD_PARTS),
                   "PowerShotPlus",
                   "PowerShotPlus");
    assertAllPaths(getStage(GENERATE_WORD_PARTS | SPLIT_ON_CASE_CHANGE),
                   "PowerShotPlus",
                   "Power Shot Plus");
    assertAllPaths(getStage(GENERATE_WORD_PARTS | SPLIT_ON_CASE_CHANGE | PRESERVE_ORIGINAL),
                   "PowerShotPlus",
                   "PowerShotPlus",
                   "Power Shot Plus");
    ...
    assertAllPaths(getStage(GENERATE_WORD_PARTS | SPLIT_ON_CASE_CHANGE | CATENATE_WORDS),
                   "PowerShotPlus",
                   "Power Shot Plus",
                   "PowerShotPlus");
    assertAllPaths(getStage(GENERATE_WORD_PARTS | SPLIT_ON_CASE_CHANGE | CATENATE_WORDS),
                   ...
                   "Power Shot1000Plus",
                   "PowerShot1000Plus");
    assertAllPaths(getStage(GENERATE_WORD_PARTS | GENERATE_NUMBER_PARTS | SPLIT_ON_CASE_CHANGE | CATENATE_WORDS | CATENATE_NUMBERS),
                   "Power-Shot-1000-17-Plus",
                   "Power Shot 1000 17 Plus",
                   "Power Shot 100017 Plus",
                   "PowerShot 1000 17 Plus",
                   "PowerShot 100017 Plus");
    assertAllPaths(getStage(GENERATE_WORD_PARTS | GENERATE_NUMBER_PARTS | SPLIT_ON_CASE_CHANGE | CATENATE_WORDS | CATENATE_NUMBERS | PRESERVE_ORIGINAL),
                   "Power-Shot-1000-17-Plus",
                   "Power-Shot-1000-17-Plus",
                   "Power Shot 1000 17 Plus",
                   "Power Shot 100017 Plus",
  ...
  public void testInvalidFlag() throws Exception {
    expectThrows(IllegalArgumentException.class,
                 () -> {
                   new WordDelimiterStage(new KeywordStage(new ReaderStage()), 1 << 31, null);
                 });
  }
  ...
  private void verify(String text, int flags) throws IOException {
    ...
    Set<String> actual = getAllPaths(getStage(flags), text);
  ...
  public void testOnlyNumbers() throws Exception {
    ...
    assertAllPaths(getStage(GENERATE_WORD_PARTS | SPLIT_ON_CASE_CHANGE | SPLIT_ON_NUMERICS), "7-586");
  }

  public void testNoCatenate() throws Exception {
    assertAllPaths(getStage(GENERATE_WORD_PARTS | GENERATE_NUMBER_PARTS | SPLIT_ON_CASE_CHANGE | SPLIT_ON_NUMERICS), "a-b-c-9-d", "a b c 9 d");
  }
  ...
  public void testEmptyString() throws Exception {
    WordDelimiterStage wdf = new WordDelimiterStage(new CannedStage(), DEFAULT_WORD_DELIM_TABLE, GENERATE_WORD_PARTS | CATENATE_ALL | PRESERVE_ORIGINAL, null);
    wdf.reset(new Object[] {
        new String[] {""},
        new int[] {0},
        new int[] {0}
      });
    assertTrue(wdf.next());
    assertFalse(wdf.next());
  }
  ...
  public void testProtectedWords() throws Exception {
    ...
    WordDelimiterStage wdf = new WordDelimiterStage(new CannedStage(), DEFAULT_WORD_DELIM_TABLE, GENERATE_WORD_PARTS | PRESERVE_ORIGINAL | CATENATE_ALL, protectedWords);
    assertAllPaths(wdf,
                   new Object[] {
                     new String[] {"foo17-bar", "foo-bar"},
                     new int[] {0, 0},
                     new int[] {9, 7},
                   },
                   "foo17-bar foo bar",
